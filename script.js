...
(() => {
  ...
  const I18N = {
    en: {
      ...
      'help.play.li1': '<strong>Top bar</strong>: shows status, selected scale, mode, current level, and <strong>Max</strong> (your best level for the current mode). A small "Paused" label appears under the language selector when the game is paused.',
      ...
      'help.mistakes.li1': 'If you tap a wrong note, the game shows a persistent Game Over message and input stops for that run.',
      'help.mistakes.li2': 'Tap anywhere to dismiss temporary notices; during Game Over you must press <strong>Restart</strong> or go Home to continue.',
    ...
    hr: {
      ...
      'help.play.li1': '<strong>Gornja traka</strong>: prikazuje status, ljestvicu, način, razinu i <strong>Maks</strong> (najbolje za način). Mala oznaka "Pauza" pojavljuje se ispod gumba za jezik kada je igra pauzirana.',
      ...
      'help.mistakes.li1': 'Ako dodirnete pogrešnu notu, igra prikazuje trajnu poruku Kraj igre i unos se zaustavlja za tu rundu.',
      'help.mistakes.li2': 'Dodirnite bilo gdje da zatvorite privremene poruke; tijekom Kraj igre morate pritisnuti <strong>Ponovno</strong> ili otiÅ¡i na Početak da nastavite.',
    ...
    pl: {
      ...
      'help.play.li1': '<strong>Pasek górny</strong>: pokazuje status, skalę, tryb, poziom oraz <strong>Max</strong> (najlepszy wynik dla trybu). Mała etykieta "Pauza" pojawia się pod przyciskiem wyboru języka, gdy gra jest wstrzymana.',
      ...
      'help.mistakes.li1': 'Jeśli stukniesz zła nutę, gra wyświetli trwały komunikat "Koniec gry", a wejscie zostanie zatrzymane dla tej rundy.',
      'help.mistakes.li2': 'Stuknij gdziekolwiek, aby zamknąć tymczasowe komunikaty; podczas "Koniec gry" musisz nacisnac <strong>Restart</strong> lub wrócic do ekranu startowego, aby kontynuowac.',
    ...
    it: {
      ...
      'help.play.li1': '<strong>Barra superiore</strong>: mostra stato, scala, modalità, livello corrente e <strong>Max</strong> (miglior livello per la modalità). Una piccola etichetta "In pausa" appare sotto il selettore della lingua quando il gioco e\u00a0in pausa.',
      ...
      'help.mistakes.li1': 'Se tocchi una nota sbagliata, il gioco mostra un messaggio permanente "Game Over" e l\u2019input si interrompe per quella partita.',
      'help.mistakes.li2': 'Tocca ovunque per chiudere i messaggi temporanei; durante "Game Over" devi premere <strong>Restart</strong> o tornare alla Home per continuare.',
    ...
    es: {
      ...
      'help.play.li1': '<strong>Barra superior</strong>: muestra estado, escala, modo, nivel actual y <strong>Max</strong> (mejor nivel del modo). Una pequeña etiqueta "En pausa" aparece bajo el selector de idioma cuando el juego esta en pausa.',
      ...
      'help.mistakes.li1': 'Si tocas una nota incorrecta, el juego muestra un mensaje persistente de "Fin de la partida" y la entrada se detiene para esa ronda.',
      'help.mistakes.li2': 'Toca en cualquier lugar para cerrar mensajes temporales; durante Fin de la partida debes pulsar <strong>Reiniciar</strong> o volver al inicio para continuar.',
